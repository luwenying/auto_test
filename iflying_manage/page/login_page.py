...
from iflying_manage.page.main_menu import MainMenu
from public_common.web_common import WebCommon
from public_common.read_data import get_yaml_data,yamlstr_to_tuple,replace_yaml_variable,replace_variable
...
class Login(WebCommon):
    ...
    def __select_application(self,sys_name):
        ...
        # self.wait_element_visible(application_element)
        # sys_name = '%s'%sys_name
